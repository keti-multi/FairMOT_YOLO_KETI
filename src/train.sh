...
## 220823 infoworks gate train
 python -W ignore ./train_test.py mot --gpus 0 --exp_id infoworks_220811_17_gate_yolov5s_5ep_288_160_with_test --data_cfg './lib/cfg/infoworks_220811_17_gate.json' \
 ...
 --save_dir /media/syh/hdd/checkpoints/FairMOT_YOLO_KETI/exp/mot/infoworks_220811_17_gate_yolov5s_5ep_288_160_with_test \
 --load_model /media/syh/ssd2/SynologyDrive/03_FairMOT/FairMOT-master/exp/mot/all_yolov5s_MOT16_288160_bs16_ep500/model_5.pth